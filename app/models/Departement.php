<?php
    ...
    class Departement {
        ...
        // Getters et Setters
        public function getId() { return $this->id_dept; }
        public function setId($id) { $this->id_dept = $id; }
        
        public function getNom(): string { return $this->nom_dept; }
        public function setNom(string $nom): void { $this->nom_dept = $nom; }
